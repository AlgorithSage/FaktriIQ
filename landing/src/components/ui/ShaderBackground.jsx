...
const UNIFORMS = {
  // Theme colors: #FFFDF5, #F5EEDB, #FFE600, #FED7AA
  colors: [
    [1.0, 0.992, 0.961], // Base cream (#FFFDF5)
    [0.961, 0.933, 0.859], // Warm ecru (#F5EEDB)
    [1.0, 0.902, 0.0],    // Brand yellow (#FFE600)
    [1.0, 0.968, 0.921],  // Lightest peach/off-white (#FFF7EB)
    [1.0, 0.992, 0.961],
    [0.961, 0.933, 0.859],
    [1.0, 0.902, 0.0],
    [1.0, 0.992, 0.961]
