                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 24),
                                  _buildAgentBullet("Clause-mapping lookup — Instantly identify which statutory chapter (OISD, Factories Act, PESO) a tagged procedure clause falls under."),
                                  _buildAgentBullet("Compliance-gap flagging — Rule-based chapter classifier flags clauses that need an EHS officer's review."),
                                  _buildAgentBullet("Clause drill-down — Inspect each flagged clause's chapter, explanation, and matched evidence in one panel."),
